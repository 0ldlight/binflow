    ...
    children: [
      ...
      { path: '/login', element: lazyEl(LoginPage) },
      {
        ...
        children: [
          ...
          // 同类控制台 reference-shaped Release Lifecycle routes. The legacy
          // /bundles family below remains a compatibility deep-link window.
          { path: 'release-lifecycle', element: lazyEl(BundlesPage) },
          { path: 'release-bundles', element: lazyEl(BundlesPage) },
          { path: 'release-bundles/target', element: lazyEl(BundlesPage) },
          { path: 'release-bundles/target-history', element: lazyEl(BundlesPage) },
          { path: 'release-bundles/target/:name', element: lazyEl(BundlesPage) },
          { path: 'release-bundles/target/:name/:version', element: lazyEl(BundlesPage) },
          { path: 'release-bundles/:name', element: lazyEl(BundlesPage) },
          { path: 'release-bundles/:name/:version', element: lazyEl(BundlesPage) },
          ...
          { path: 'bundles/target/:name', element: lazyEl(BundlesPage) },
          { path: 'bundles/target/:name/:version', element: lazyEl(BundlesPage) },
