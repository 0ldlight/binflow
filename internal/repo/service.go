...
// five keep their own class rulings (the matrix has refused nothing since
// T-431 opened virtual docker onto the T-365 aggregated read plane; remote
// docker opened earlier, T-392 onto the /v2 remote seam) and a
