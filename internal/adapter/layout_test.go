...
func TestLayoutTable(t *testing.T) {
	tests := []struct {
		...
		{name: "NUL in segment", path: "r/b\x00.bin", wantErr: true},
		{name: "LF in segment", path: "r/b\x0a.bin", wantErr: true},
		{name: "CR in segment", path: "r/b\x0d.bin", wantErr: true},
		{name: "tab in segment", path: "r/b\x09.bin", wantErr: true},
		{name: "DEL in segment", path: "r/b\x7f.bin", wantErr: true},
