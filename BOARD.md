...
#### M9 UI 消费波（在途）
- **T-257** [P0] users/groups 页消费（N+1 退役 + Status 真值 + 删除面 + 词表） `role:dev-frontend` — **doing 2026-08-24**
- **T-258** [P0] repos 已用列单请求注水（≤3 请求硬断言） `role:dev-frontend` — **doing 2026-08-24**
