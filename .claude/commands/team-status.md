...
1. 读 `BOARD.md`（2026-09-25 起冻结为只读历史快照，尾部日志与里程碑分节为历史实态源）与新任务载体 `reports/agents/T-*.md`（Linear 回填前的过渡口径），按八态（DISCOVERY/SPECIFIED/READY/IMPLEMENTING/REVIEW/QA/DIFFERENTIAL/UAT/done，含 blocked）汇总票据（编号、标题、角色）。
