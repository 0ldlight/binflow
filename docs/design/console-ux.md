...
| `/admin/security/{users\|groups\|permissions\|tokens}[/:name\|/new]` | `users-*` `user-*` `groups-*` `perm-*` 族 / T-386 批 `tokens-*` 族（见下——占位页锚已退役） | 原 `/security/*` |
