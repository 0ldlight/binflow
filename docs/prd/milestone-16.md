...
| **K73**（v1.2 新增） | repoLayoutRef 布局联动评估（B-1.5 承接票前置——T-439 契约漂移登记归位） | BinFlow 布局由协议 adapter 固定、**无 repoLayoutRef 消费方**——BE 承接票（configJSON 转发 + round-trip）落地时须接线布局引擎或钉协议默认值；候「M16 未纳入项」BE 承接票立项定案 |
