...
main() {
  ...
  log "M13 knobs:       same env file — BINFLOW_WEBHOOK__ALLOW_PRIVATE_TARGET"
  log "                  (default false), BINFLOW_FOLDER_DOWNLOAD__*,"
  log "                  BINFLOW_TRASHCAN__RETENTION_DAYS (default 14);"
  log "                  resolved values echo at /binflow/api/v1/system/settings"
  log ""
