...
- 状态: Accepted（2026-09-01，M15 B0 T-408 交付；与 T-407〔aql.md 规格票〕B0 并行——本 ADR 定**机制与 Go 侧契约**，字段全集/操作符闭集/错误文案/compact 形态/virtual 语义等**字面契约以 aql.md 定案为准**，Accepted 前逐项对齐（见「软缝对齐清单」），分歧以勘误留痕回填——ADR-0041「定机制不定字面量」同款条款）
- 日期: 2026-09-01
